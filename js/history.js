...
function loadGSAP() {
  ...
  imagesAndText.forEach(function (element, index) {
    ...
    if (count % 2 == 0) {
      // even
      gsap.from(element, { opacity: 0, x: -30, scrollTrigger: { toggleActions: "play pause resume reset", start: "top 85%", end: "top 60%", trigger: element, scrub: true } });
    }
    if (count % 2 != 0) {
      // odd
      gsap.from(element, { opacity: 0, x: 30, scrollTrigger: { toggleActions: "play pause resume reset", start: "top 85%", end: "top 60%", trigger: element, scrub: true } });
  ...
  lines.forEach(function (line, index) {
    ...
    if (count % 2 != 0) {
      // odd
      gsap.from(line, { transformOrigin: "left", transform: "scaleX(0.01)", scrollTrigger: { toggleActions: "play pause resume reset", start: "top 95%", end: "top 70%", trigger: line, scrub: true } });
    }

    if (count % 2 == 0) {
      // even
      gsap.from(line, { transformOrigin: "right", transform: "scaleX(0.01)", scrollTrigger: { toggleActions: "play pause resume reset", start: "top 95%", end: "top 70%", trigger: line, scrub: true } });
    }
  });
  ...
  dates.forEach(function (date, index) {
    ...
    if (count % 2 != 0) {
      // odd
      gsap.from(date, { x: -1, opacity: "0", transformOrigin: "left", transform: "scale(0.01,0.01)", scrollTrigger: { toggleActions: "play pause resume reset", start: "top 95%", end: "top 70%", trigger: date, scrub: true } });
    }

    if (count % 2 == 0) {
      // even
      gsap.from(date, { x: 1, opacity: "0", transformOrigin: "right", transform: "scale(0.01,0.01)", scrollTrigger: { toggleActions: "play pause resume reset", start: "top 95%", end: "top 70%", trigger: date, scrub: true } });
    }
  });
  ...
  letterGroups.forEach(function (letter) {
    ...
    textPixelPath.forEach(function (pixel, index) {
      gsap.to(pixel, {
        ...
        scrollTrigger: {
          start: "top 40%",
          trigger: trigger, // use 1 : 0.033 ratio
        },
      });
    });
  });
  ...
  //colors footer red
  gsap.from("footer", { backgroundColor: "#1e1c1d", scrollTrigger: { toggleActions: "play pause resume reset", start: "top 100%", end: "top 70%", trigger: "footer", scrub: true } });

  //moves and unfades text
  gsap.from("footer h2", { opacity: 0, x: -50, y: 20, scrollTrigger: { toggleActions: "play pause resume reset", start: "top 90%", end: "top 70%", trigger: "footer", scrub: true } });

  //moves and unfades text
  gsap.from("footer p", { opacity: 0, x: 50, y: 20, scrollTrigger: { toggleActions: "play pause resume reset", start: "top 90%", end: "top 70%", trigger: "footer", scrub: true } });

  //moves and unfades text
  gsap.from("footer h4", { opacity: 0, x: -50, y: 20, scrollTrigger: { toggleActions: "play pause resume reset", start: "top 90%", end: "top 70%", trigger: "footer", scrub: true } });

  //moves and unfades text
  gsap.from("footer li", { opacity: 0, x: 50, y: 20, scrollTrigger: { toggleActions: "play pause resume reset", start: "top 90%", end: "top 70%", trigger: "footer", scrub: true } });
  ...
  gsap.to("#downArrow", {
    opacity: 0,
    // arrow in section 1
    scrollTrigger: { toggleActions: "play pause resume reset", start: "top 90%", end: "top 60%", trigger: downTrigger, scrub: true },
  });
